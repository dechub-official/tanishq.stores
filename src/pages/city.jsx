...
<StorePlate key={i} data={data}/>
  ...
  {data.length <= 1&&<VisitorInfoCard/>}
                    {/* {data.length <= 1 && <><div className="box overflow-hidden bg-[#F2F2F2] md:w-[45%] max-h-[330px] md:min-h-[330px] min-h-[300px]  my-4  rounded-[22px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
                        {success.visible == false ? <><div className="flex px-2 md:px-8 p-4 justify-center items-center">
                            ...
                            <div className="flex justify-center items-center flex-col">
                                <h2 className=' text-center text-red-900 text-[15px] mx-2 md:text-[18px]  font-medium md:w-[80%]'>Subscribe for exclusive offers on your favorite jewellery designs, gold rate updates, and festive benefits from Tanishq!</h2>
                                ...
                                <div className=" w-[88%]">
                                    <div className="w-[30%]">
                                        {/* <Button name="Submit" style="" onclick={() => {
                                               getUpdates()
                                            }}
                        ...
                        {/* </> : <>
                            ...
                            <div className="relative">
                                <div className=" absolute right-3 top-2 cursor-pointer font-[600] text-[#803335] " onClick={() => setSuccess({ ...success, visible: false })}>X</div>
                            </div>
                            <div className="flex w-full justify-center  items-center">
                                <img src={img} className=' w-full ' alt="" />

                            </div>
                            {success.success ? <div className="flex flex-col justify-center h-full mt-[10%] md:mt-[10px] items-center">
                            ...
                            </div> : <div className="flex flex-col justify-center  mt-[10%] md:mt-[10px] items-center">
                                <h3 className="text-[#832729] font-[500] text-[20px] md:text-[25px]">Check your phone number</h3>
                                <h3 className=" font-[500] my-2 text-[15px] md:mx-3 mx-2 text-center"> You can also try with a different number and get notified of the best offers, gold rates, and other benefits from Tanishq! Try again?</h3>
                            </div>}
