       ...
       <div className="flex justify-center w-full">
          ...
          <ul className="flex flex-col">
           {props.data?.map((data,i)=>{
            return  <li key={i}  onClick={()=>{handleChange(i)}} className={open[i]!=0?`bg-[#F3F3F3] my-2  rounded-[5px] shadow-lg border-r-4  border-[#832729]`:'bg-[#F3F3F3] my-2 shadow-lg  rounded-[5px]'} x-data="accordion(1)">
            <h2
