...
export default function BookAnAppointment({ openingTime, closingTime, isOpen, setisOpen,storeCode,storeName,page="deepStore" }) {
    ...
    const timeDivisions = [
        {
            division: "Morning",
            icon: <svg width={page=="deepStore"?"14":"30"} height={page=="deepStore"?"14":"30"} className="mb-1 " viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            division: "Noon",
            icon: <svg width={page=="deepStore"?"11":"25"} height={page=="deepStore"?"11":"25"} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            division: "Evening",
            icon:
                <svg width={page=="deepStore"?"13":"30"} height={page=="deepStore"?"14":"30"} viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
