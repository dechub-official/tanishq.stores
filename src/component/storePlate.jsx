...
export default function StorePlate({data}) {
    ...
    return <>
     <div className="box bg-[#F2F2F2] md:min-w-[500px] min-w-[310px]  max-w-[310px] md:max-w-[500px] min-h-[350px] md:max-h-[350px]  my-4 px-2 md:px-8 p-4 rounded-[22px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
