...
export default function StorePlate({data}) {
    ...
    return <>
     <div className="box bg-[#F2F2F2] md:min-w-[450px] min-w-[90%]  max-w-[500px] md:max-w-[450px] min-h-[350px] md:max-h-[350px]  my-4 px-2 md:px-8 p-4 rounded-[22px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
