    ...
    return <>
        <div className="flex flex-col md:w-[82%] w-[90%] mx-auto  justify-center af-bl">
            ...
            <div className=" flex flex-col mt-8  my-6 relative">
                ...
                <img src={image} onClick={Navigate} className=" cursor-pointer md:block hidden rounded-xl" alt="" />
              
                <img src={mobImage} onClick={Navigate} className="md:hidden rounded-xl block" alt="" />
