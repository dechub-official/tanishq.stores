    ...
    return <>
        ...
        <div className=" relative flex flex-col w-full">
          ...
          /></>}
            ...
            {<div className={active&&searchResult.length > 0 ? "absolute top-[90%] py-2 bg-white z-10 md:left-[38%] left-[10%] md:w-[25%] w-[80%] rounded-[5px]  shadow-[rgba(0,0,0,0.02)_0px_1px_3px_0px,rgba(27,31,35,0.15)_0px_0px_0px_1px] border-gray-600   float-right" : "absolute hidden  md:left-[38%] left-[10%] md:w-[25%] w-[80%]  top-[90%] py-2 opacity-0"}>
