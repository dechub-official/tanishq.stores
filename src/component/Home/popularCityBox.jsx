...
export default function PopularCity({img,name}) {
    ...
    {/* border-radius: 14px;
background: #ECECEC; */}
    <div onClick={()=>nav(`/store-locator/jewellery-stores/city/${name}`)} className=" overflow-hidden relative cursor-pointer md:w-[100px] w-[80px] md:h-[unset] duration-150 s hover:scale-[1.1] h-[90px] md:m-2  m-1  md:mx-0 md-m-0 flex justify-center flex-col items-center rounded-[10px] shadow-[rgba(0,0,0,0.24)_0px_3px_8px] bg-[white] px-2 py-5 pb-2">
