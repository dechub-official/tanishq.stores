    ...
    return <>
        <div className="flex flex-col w-[88%] mx-auto  justify-center af-bl">
            ...
            <div className=" flex flex-col mt-8  my-6 relative">
                ...
                <div className="md:w-[50%] top-[30%] md:top-[60%] md:left-[3%] md:transform-none w-full  absolute flex flex-col items-center justify-center">
                  
                    <p className=" text-[18px]   text-[rgba(119,7,10,0.70)] italic  font-serif  text-center font-[200] max-w-[250px]">Welcome to {name}</p>
                 <p className=" text-[18px] md:block hidden   text-black italic  font-fraunces  text-center font-normal max-w-[390px]">Exchange festival is live, <br /> Get upto 2KT <sup> *</sup> extra on old gold value</p>
