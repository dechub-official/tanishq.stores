...
import OfferBannerImg from '../../assets/images/Banner/ICICIDesktop.jpg'
import MobileOfferBanner from '../../assets/images/Banner/ICICIMob.jpg'

export default function Banner({name}) {
    return <>
     <div className="flex justify-center af-bl">
                    <div className="w-[90%]  flex flex-col  my-6 relative">
