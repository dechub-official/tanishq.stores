...
export default function Footer() {
    const data=[{head:<h1 className="text-[#832729] text-[18px] mb-2 font-[700]">Useful Links</h1>,links:<> <p className="text-[#414042] text-[16px] my-2">Delivery Information </p>
    <p className="text-[#414042] text-[16px] my-2">International Shipping </p>
    <p className="text-[#414042] text-[16px] my-2">Payment Options </p>
    <p className="text-[#414042] text-[16px] my-2">Track Your Order</p>
    <p className="text-[#414042] text-[16px] my-2">Returns</p>
    <p className="text-[#414042] text-[16px] my-2">Find a Store</p></>},{
        head:  <h1 className="text-[#832729] text-[18px] mb-2 font-[700]">Information</h1>,links:<> <p className="text-[#414042] text-[16px] my-2">Careers</p>
        <p className="text-[#414042] text-[16px] my-2">Blog </p>
        <p className="text-[#414042] text-[16px] my-2">Offers & Contest Details </p>
        <p className="text-[#414042] text-[16px] my-2">Help & FAQS </p>
        <p className="text-[#414042] text-[16px] my-2">Returns</p>
        <p className="text-[#414042] text-[16px] my-2"> About Tanishq</p></>

    },{
        head:<h1 className="text-[#832729] text-[18px] mb-2 font-[700]">Contact Us</h1>,
        links:<>  <p className="text-[#414042] text-[16px] my-2"> Write to Us</p>
        <p className="text-[#414042] text-[16px] my-2">1800-266-0123 </p>
    ...
    return <>
           ...
           {open[i]=="fit"&& <div
             ...
             {data.links}
                ...
                <div className="us-link md:text-start text-center md:block hidden">
                    ...
                    <p className="text-[#414042] text-[18px] my-2">Delivery Information </p>
                    <p className="text-[#414042] text-[18px] my-2">International Shipping </p>
                    <p className="text-[#414042] text-[18px] my-2">Payment Options </p>
                    <p className="text-[#414042] text-[18px] my-2">Track Your Order</p>
                    <p className="text-[#414042] text-[18px] my-2">Returns</p>
                    <p className="text-[#414042] text-[18px] my-2">Find a Store</p>
                </div>
                <div className="us-link md:text-start text-center md:block hidden">
                    <h1 className="text-[#832729] text-[20px] font-[600]">Information</h1>
                    <p className="text-[#414042] text-[18px] my-2">Careers</p>
                    <p className="text-[#414042] text-[18px] my-2">Blog </p>
                    <p className="text-[#414042] text-[18px] my-2">Offers & Contest Details </p>
                    <p className="text-[#414042] text-[18px] my-2">Help & FAQS </p>
                    <p className="text-[#414042] text-[18px] my-2">Returns</p>
                    <p className="text-[#414042] text-[18px] my-2"> About Tanishq</p>
                </div>
                <div className="us-link md:text-start text-center md:block hidden">
                    <h1 className="text-[#832729] text-[20px] font-[600]">Contact Us</h1>
                    <p className="text-[#414042] text-[18px] my-2"> Write to Us</p>
                    <p className="text-[#414042] text-[18px] my-2">1800-266-0123 </p>
                    <p className="text-[#414042] text-[18px] my-2">Chat with US </p>

                </div>
                <div className="us-link text-center">
                    <h1 className="text-[#832729] text-[20px] font-[600]">Download the Tanishq App Now</h1>
                    <div className="flex justify-around my-4">
                        <img src={gplay} alt="" className='w-[126px]' />
                        <img src={astore} alt="" className='w-[126px]' />
                    </div>
        ...
        <div className="bank flex  justify-between md:mx-16 my-6 border-[#414042] border-t-2 pt-9 pb-2 flex-wrap-reverse ">
            <div className="bank flex justify-around md:w-[70%] flex-wrap ">
                <img src={b9} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0  ' />
                <img src={b1} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                <img src={b2} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                <img src={b3} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                <img src={b4} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' /> 
                <img src={b5} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' /> 
                <img src={b6} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                <img src={b7} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                <img src={b8} alt=""className='md:w-[56px] w-[50px] md:h-[25px] mr-5 my-4 md:my-0' />
                {/* <img src={b9} alt="" /> */}
            ...
            <div>
                <p className='text-[13px] text-center text-[#832729] font-[500]'>ⓒ 2023 Titan Company Limited. All Rights Reserved. <br/>Terms & Conditions | Privacy Policy</p>
            </div>
        </div>
        </div>
