       ...
       <div className="my-3 px-4  gap-x-1">
           ...
           <div className="relative mb-6 mt-10 ">
               <label className="ibm-plex text-[#636363] font-medium flex gap-x-1 mb-3 text-[14px]" htmlFor="">
                   ...
                   Full Name *</label>
               <input autocomplete="off" type="text" name="name" onChange={handleInputChange} className="px-4 border w-[90%]  py-3 placeholder:text-[#969288] placeholder:font-medium ibm-plex outline-none rounded-full shadow-md " placeholder="Name" />
           ...
           <div className="relative my-6 ">
               <label className="ibm-plex text-[#636363] font-medium flex items-center mb-3 gap-x-1 text-[14px]" htmlFor="">
                   ...
                   Phone Number*</label>
               <input autocomplete="off" type="text" name="phone" onChange={handleInputChange} className="px-4 border w-[90%]  py-3 placeholder:text-[#969288] placeholder:font-medium ibm-plex outline-none rounded-full shadow-md " placeholder="Phone" />
           ...
           <div className="relative mt-6 mb-8 ">
               <label className="ibm-plex text-[#636363] font-medium flex items-center mb-3 gap-x-1 text-[14px]" htmlFor="">
                   ...
                   E-mail*</label>
               <input autocomplete="off" type="email" name="email" onChange={handleInputChange} className="px-4 border w-[90%]  py-3 placeholder:text-[#969288] placeholder:font-medium ibm-plex outline-none rounded-full shadow-md " placeholder="E-mail" />
