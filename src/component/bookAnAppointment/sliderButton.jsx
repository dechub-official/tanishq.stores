...
const ButtonStrip = ({ days, weekDays, dayInfo, setDayInfo, timeDivisions, isTimeDisabled, handleDivisions, activeDivision, activeModal, setActiveModal }) => {
    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <p className="flex gap-x-2 mb-5 ibm-plex text-[17px]  items-center font-medium text-[#636363]">
                <svg width="17" height="17" className="mb-1" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1339_499)">
                        <path d="M14.6849 1.5332H2.31431C1.22278 1.5332 0.337891 2.4181 0.337891 3.50962V15.0236C0.337891 16.1151 1.22278 17 2.31431 17H14.6849C15.7764 17 16.6613 16.1151 16.6613 15.0236V3.50962C16.6613 2.41804 15.7764 1.5332 14.6849 1.5332Z" fill="#832729" />
                        ...
                        <path d="M3.57606 0C3.37228 0 3.20703 0.165246 3.20703 0.369033V3.24427C3.20703 3.44811 3.37228 3.6133 3.57606 3.6133C3.77985 3.6133 3.9451 3.44811 3.9451 3.24427V0.369033C3.9451 0.165246 3.77991 0 3.57606 0Z" fill="#832729" />
                        ...
                        <path d="M6.85731 0C6.65353 0 6.48828 0.165246 6.48828 0.369033V3.24427C6.48828 3.44811 6.65353 3.6133 6.85731 3.6133C7.0611 3.6133 7.22635 3.44811 7.22635 3.24427V0.369033C7.22635 0.165246 7.0611 0 6.85731 0Z" fill="#832729" />
                        ...
                        <path d="M10.1405 0C9.93673 0 9.77148 0.165246 9.77148 0.369033V3.24427C9.77148 3.44811 9.93673 3.6133 10.1405 3.6133C10.3443 3.6133 10.5095 3.44811 10.5095 3.24427V0.369033C10.5095 0.165246 10.3443 0 10.1405 0Z" fill="#832729" />
                        ...
                        <path d="M13.4237 0C13.2199 0 13.0547 0.165246 13.0547 0.369033V3.24427C13.0547 3.44811 13.2199 3.6133 13.4237 3.6133C13.6275 3.6133 13.7928 3.44811 13.7928 3.24427V0.369033C13.7928 0.165246 13.6276 0 13.4237 0Z" fill="#832729" />
            ...
            <p className="flex gap-x-2 mt-10 mb-5 ibm-plex text-[17px]  items-center font-medium text-[#636363]">
                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.6205 14.3917C15.7698 12.2424 15.7698 8.75762 13.6205 6.60828C11.4711 4.45895 7.98636 4.45895 5.83703 6.60829C3.68769 8.75762 3.68769 12.2424 5.83703 14.3917C7.98636 16.541 11.4711 16.541 13.6205 14.3917Z" fill="#832729" />
                    <path d="M14.5939 15.3646C17.2806 12.678 17.2806 8.32203 14.5939 5.63536C11.9072 2.9487 7.5513 2.9487 4.86464 5.63536C2.17797 8.32203 2.17797 12.678 4.86464 15.3646C7.5513 18.0513 11.9072 18.0513 14.5939 15.3646Z" stroke="#832729" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <path d="M9.729 3.62206C10.109 3.62206 10.417 3.31404 10.417 2.93408C10.417 2.55411 10.109 2.24609 9.729 2.24609C9.34904 2.24609 9.04102 2.55411 9.04102 2.93408C9.04102 3.31404 9.34904 3.62206 9.729 3.62206Z" stroke="#832729" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
