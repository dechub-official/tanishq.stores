...
<div className={` block shadow-[#832729] shadow-[0_10px_20px_rgba(240,_46,_170,_0.7)] fixed overflow-visible z-[70] ${isOpen ? "bottom-[0]" : "bottom-[-150%]"} transition-all duration-150 md:hidden left-0 font-fraunces  h-fit  max-h-[450px] min-h-[450px] px-2 overflow-scroll !rounded-t-xl  !rounded-b-none w-full bg-white`}>
    ...
    {step == 1 &&
        <>
            <h1 className="text-black px-4 text-[22px] leading-normal font-fraunces  text-left mt-[2rem] mb-1 font-[400]"><span className="text-[#832729] font-fraunces ">Heading to </span> {cities[activeStore]?.storeName}</h1>
