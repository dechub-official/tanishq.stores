        ...
        <>
            {step === 1 ?
                <div className="w-[100%] h-[100%] flex flex-col justify-between items-start">
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div><h3 className="fraunces leading-[40px] text-[#767469] text-[35px] font-normal">Book a   <br></br><span className="fraunces text-[#070202]"> private visit</span></h3></div>
                        <div> <img className="w-[100px]" src={logo} alt="tanishq logo" /></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span className="text-[18px] text-normal text-[#644117] ibm-plex">I’d like to book a private visit to explore</span>
                            <div className="relative w-60">
                                <select
